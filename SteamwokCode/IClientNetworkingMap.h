class IClientNetworkingMap
{
	...
	virtual void * CreateListenSocket( int32, SteamIPAddress_t, uint16, bool ) = 0;
	virtual void * CreateP2PConnectionSocket( CSteamID, int32, int32, bool ) = 0;
	virtual void * CreateConnectionSocket( SteamIPAddress_t, uint16, int32 ) = 0;
	...
	virtual void * GetSocketInfo( uint32, CSteamID *, int32 *, SteamIPAddress_t *, uint16 * ) = 0;
	virtual void * GetListenSocketInfo( uint32, SteamIPAddress_t *, uint16 * ) = 0;
