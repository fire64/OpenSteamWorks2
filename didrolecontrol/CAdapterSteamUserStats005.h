class CAdapterSteamUserStats005
{
	...
	virtual unknown_ret GetDownloadedLeaderboardEntry( uint64, int32, LeaderboardEntryOld_t *, int32 *, int32 ) = 0;
	virtual unknown_ret UploadLeaderboardScore( uint64, int32, const int32 *, int32 ) = 0;
};
