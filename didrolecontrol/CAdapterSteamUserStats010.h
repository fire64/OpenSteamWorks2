class CAdapterSteamUserStats010
{
	...
	virtual unknown_ret GetMostAchievedAchievementInfo( char *, uint32, float *, bool * ) = 0;
	virtual unknown_ret GetNextMostAchievedAchievementInfo( int32, char *, uint32, float *, bool * ) = 0;
	virtual unknown_ret GetAchievementAchievedPercent( const char *, float * ) = 0;
	virtual unknown_ret RequestGlobalStats( int32 ) = 0;
	virtual unknown_ret GetGlobalStat( const char *, int64 * ) = 0;
	virtual unknown_ret GetGlobalStat( const char *, double * ) = 0;
	virtual unknown_ret GetGlobalStatHistory( const char *, int64 *, uint32 ) = 0;
	virtual unknown_ret GetGlobalStatHistory( const char *, double *, uint32 ) = 0;
};
