class CAdapterSteamMatchmaking007
{
	...
	virtual unknown_ret AddRequestLobbyListStringFilter( const char *, const char *, ELobbyComparison ) = 0;
	virtual unknown_ret AddRequestLobbyListNumericalFilter( const char *, int32, ELobbyComparison ) = 0;
	...
	virtual unknown_ret DeleteLobbyData( CSteamID, const char * ) = 0;
