class CAdapterSteamFriends009
{
	...
	virtual unknown_ret SetRichPresence( const char *, const char * ) = 0;
	virtual unknown_ret ClearRichPresence() = 0;
	virtual unknown_ret GetFriendRichPresence( CSteamID, const char * ) = 0;
	...
	virtual unknown_ret InviteUserToGame( CSteamID, const char * ) = 0;
