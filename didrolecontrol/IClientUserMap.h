class IClientUserMap
{
	...
	virtual void * SetConfigBinaryBlob( EConfigSubTree, char const*, CUtlBuffer * ) = 0;
	virtual void * GetConfigBinaryBlob( EConfigSubTree, char const*, CUtlBuffer * ) = 0;
	...
	virtual void * SignalAppsToShutDown( CGameID ) = 0;
	virtual void * TerminateAppMultiStep( CGameID, uint32 ) = 0;
	...
	virtual void * BEnableEmbeddedClient( uint32 ) = 0;
	virtual void ResetEmbeddedClient( uint32 ) = 0;
	virtual void * BHasEmbeddedClientToken( uint32 ) = 0;
	virtual void RequestEmbeddedClientToken( uint32 ) = 0;
	virtual void AuthorizeNewDevice( uint32, uint32, char const* ) = 0;
	...
	virtual void * SpawnProcess( char const*, char const*, char const*, CGameID, char const*, uint32, uint32, uint32 ) = 0;
	...
	virtual void * GetAuthSessionTicketForGameID( void *, int32, uint32 *, CGameID ) = 0;
	...
	virtual void * RaiseWindowForGame( CGameID ) = 0;
	...
	virtual void * BSetDurationControlOnlineStateForApp( EDurationControlOnlineState, uint32 ) = 0;
	...
	virtual void * BIsLockFromSiteLicense() = 0;
	...
	virtual void * GetTextFilterSetting() = 0;
	virtual void * BTextFilterIgnoresFriends() = 0;
	...
	virtual void ClearAndSetAppTags( CGameID, SteamParamStringArray_t const* ) = 0;
	...
	virtual void UpdateGameVrDllState( CGameID, bool, bool ) = 0;
	virtual void * BIsAnyGameOrServiceAppRunning() = 0;
	virtual void * BGetAppArrayMinutesPlayed( uint32 *, int32, int32 *, int32 * ) = 0;
	virtual void * BGetAppsLastPlayedTime( uint32 *, int32, uint32 * ) = 0;
	virtual void SendSteamServiceStatusUpdate( EResult, ESteamServiceStatusUpdate ) = 0;
	virtual void * RequestSteamGroupChatMessageNotifications( uint64, uint64, EChatNotificationFormat ) = 0;
	virtual void * RequestSteamGroupChatMessageHistory( uint64, uint64, uint32 ) = 0;
	virtual void * RequestSendSteamGroupChatMessage( uint64, uint64, uint32, char const* ) = 0;
	virtual void OnNewGroupChatMsgAdded( uint64, uint64, uint32, uint32, uint32, char const* ) = 0;
	virtual void OnGroupChatUserStateChange( uint64, uint32, int32 ) = 0;
	virtual void OnReceivedGroupChatSubscriptionResponse( uint64, uint64, bool ) = 0;
	virtual void * GetTimedTrialStatus( uint32, uint32 *, uint32 * ) = 0;
	virtual void * RequestTimedTrialStatus( uint32 ) = 0;
};
